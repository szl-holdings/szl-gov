...
def main() -> int:
    ...
    contradictions = [
        ...
        {"id": "HW-003", "severity": "HIGH",
         "statement": "Apex a-11-oy.com returns a Hugging Face 404; only www is registered as a Space custom domain. Every apex reference across READMEs, badges and the org card is broken.",
         "resolution": "Add a-11-oy.com as a custom domain on SZLHOLDINGS/a11oy, or add a Cloudflare redirect rule apex to www. Pricing page Product link repointed to www in a11oy-net PR #102 as interim."},
