...
def main() -> int:
    ...
    contradictions = [
        ...
        {"id": "HW-003", "severity": "RESOLVED",
         "statement": "Product domain TLS was broken during a DNS migration off Cloudflare to Hugging Face direct custom domain: HF served its default CN=hf.space cert, so both apex and www failed TLS.",
         "resolution": "RESOLVED 2026-09-01. Apex custom domain finished provisioning: a-11-oy.com returns 200 with subject=CN=a-11-oy.com. Note www.a-11-oy.com is now the 404 side; apex is canonical per doctrine. Pricing Product link pointed back to apex in a11oy-net PR #105."},
